...
namespace SDP.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> GenerateInvoice()
        {
            ...
            int customerId = 0;
            SqlConnection cnn;
            String connectionString = "Server=localhost;Database=shopDB;User=sa;Password=root;";
            cnn = new SqlConnection(connectionString);
            cnn.Open();
        ...
        public ActionResult MailInvoice() {
            ...
            string from = "numlumer@gmail.com"; //From address    
            ...
            System.Net.NetworkCredential("numlumer@gmail.com", "");
